...
const ServiceRow = ({ service, index }) => {
  ...
  return (
    <motion.div
      ...
      className="group flex items-start justify-between gap-10 border-b border-zinc-200 py-10 px-[3.922vw] cursor-default"
    ...
    >
      {/* Number */}
      <span className="text-zinc-400 font-['NeueMontrealLight'] text-[1.1vw] mt-1 w-[4vw] shrink-0">
        {service.number}
      </span>

      {/* Title */}
      <div className="w-[28vw] shrink-0">
        <h2 className="font-['FoundersGrotesk'] uppercase text-[3vw] leading-none text-zinc-900 group-hover:text-[#004d43] transition-colors duration-300">
          {service.title}
        </h2>
      </div>
      ...
      <div className="flex-1 flex flex-col gap-4">
        <motion.p
          className="font-['NeueMontrealLight'] text-[1.1vw] text-zinc-500 leading-relaxed max-w-[40vw]"
      ...
      {/* Arrow */}
      <motion.span
        className="text-zinc-400 text-2xl mt-1 shrink-0"
...
const Services = () => {
  ...
  return (
    <div ref={ref} id="services" className="relative z-10 bg-white w-full pt-28 pb-20">
      {/* Header */}
      <div className="flex items-end justify-between px-[3.922vw] pb-10 border-b border-zinc-200">
        <motion.h1
          style={{ x: headingX }}
          className="font-['FoundersGrotesk'] uppercase text-[7vw] leading-none text-zinc-900"
        >
          Services
        </motion.h1>
