...
const About = () => {
  ...
  return (
    <div
      ref={aboutRef}
      id="about"
      className="relative z-20 w-full py-12 md:py-20 bg-white rounded-t-3xl text-zinc-900 -mt-[12vw]"
    >
      {/* Section label */}
      ...
      <div className="flex flex-col lg:flex-row gap-7 md:gap-10 px-5 md:px-[3.922vw] mt-8 justify-between items-start">
        <div className="flex flex-col gap-4 items-start">
          <h3 className="text-[7vw] md:text-[4vw] text-zinc-900">Our approach:</h3>
          <button className="px-6 py-4 rounded-full text-[4vw] md:text-[1.184vw] flex gap-7 items-center justify-between bg-[#004d43] border border-[#004d43] text-white hover:bg-zinc-900 hover:border-zinc-900 transition-all duration-300">
            <span>READ MORE</span>
            <div className="w-2 h-2 rounded-full bg-current"></div>
          </button>
        </div>
        <div className="rounded-2xl overflow-hidden flex items-center justify-center w-full max-w-[400px] md:w-[600px] border border-zinc-200 mt-6 md:mt-0">
          <img
